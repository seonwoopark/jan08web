...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section>
            ...
            <div class="mt-3 container bg-info text-white">
            	구역
            	<div class="m-5 mb-0 bg-primary">
            		구역2
            	</div>
            	<div class="my-4 py-5 bg-secondary">
            		구역3
            	</div>
            	<div class="my-2 py-5 bg-secondary w-25">
            		구역4
            	</div>
            	<div class="my-2 py-5 bg-secondary w-50">
            		구역5
            	</div>
            	<div class="my-2 py-5 bg-secondary w-75">
            		구역6
            	</div>
            </div>
        </section>
